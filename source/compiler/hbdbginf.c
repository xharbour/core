/*
 * $Id: hbdbginf.c 9722 2012-10-02 06:13:24Z andijahja $
 */
   ...
   while( pFunc )
   {
      ...
      while( ulPos < pFunc->lPCodePos )
      {
         ...
         switch( pFunc->pCode[ ulPos ] )
         {
            ...
            case HB_P_BASELINE:
               ulLine = ulBase = HB_PCODE_MKUSHORT( &pFunc->pCode[ ulPos + 1 ] );
               break;

            case HB_P_LINEOFFSET:
               ulLine = ulBase + pFunc->pCode[ ulPos + 1 ];
               break;
