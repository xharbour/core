 ...
 * Generate PCODE statistics
 *
 * Copyright 2006 Przemyslaw Czerpak < druzus /at/ priv.onet.pl >
 *
 * The table of PCODE names and idea by:
 * Copyright 2003 Andi Jahja <andijahja@xharbour.com>
 *
...
static const char * hb_comp_pcode_names[] =
{
...
void hb_compPCodeStat( PHB_FNAME pFileName )
{
...

   {
      ...
      pCodeCount  = ( ULONG * ) hb_xgrab( HB_P_LAST_PCODE * sizeof( ULONG ) );
