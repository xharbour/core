/*
 * $Id: datetime.prg 9279 2011-02-14 18:06:32Z druzus $
 */
...
*: lLeap is FALSE for a non-leap year but TRUE if it is. If so and 
...
*:  lRet :=  isleap ( ddate )
*:  ========================
*:  if ddate is a leap year, lRet is TRUE, otherwise FALSE.
