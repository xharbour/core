/*
 * $Id: wvwmouse.prg 9279 2011-02-14 18:06:32Z druzus $
 */
/*
  WVWMOUSE.PRG
  ...
  if lPressed //::lPressed
     ...
     if lUseImage .and. !(::nType==_BUTTON_NONE)
        if !Wvw_DrawImage( nWinNum, ::nRow1, ::nCol1, ::nRow2, ::nCol2, ::cImage, ::lTight )
           messagebox(NIL, "Button Failed Wvw_DrawImage(" + ::cImage + ")")
        endif
     endif
...
#ELSE
  standard Harbour restricts __keyboard to chr typed only...
#ENDIF
