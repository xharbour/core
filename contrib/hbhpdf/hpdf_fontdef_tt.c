/*
 * $Id: hpdf_fontdef_tt.c 9752 2012-10-14 03:33:16Z andijahja $
 */
/*
...
HPDF_TTFontDef_New (HPDF_MMgr   mmgr)
{
    ...
    fontdef_attr = (HPDF_TTFontDefAttr)HPDF_GetMem (mmgr, sizeof(HPDF_TTFontDefAttr_Rec));
    if (!fontdef_attr) {
              ...
              HPDF_UINT     offset)
{
    ...
    fontdef->cap_height =
                (HPDF_UINT16) HPDF_TTFontDef_GetCharBBox (fontdef,'H').top;
    fontdef->x_height =
                (HPDF_UINT16) HPDF_TTFontDef_GetCharBBox (fontdef, 'x').top;
    fontdef->missing_width = (HPDF_UINT32)(attr->h_metric[0].advance_width * 1000 /
                (HPDF_UINT16) attr->header.units_per_em);
                             ...
                             HPDF_UINT16    unicode)
{
    ...
    bbox.left = (HPDF_REAL)(i * 1000 / attr->header.units_per_em);

    ret += GetINT16 (attr->stream, &i);
    bbox.bottom = (HPDF_REAL)(i * 1000 / attr->header.units_per_em);

    ret += GetINT16 (attr->stream, &i);
    bbox.right = (HPDF_REAL)(i * 1000 / attr->header.units_per_em);

    ret += GetINT16 (attr->stream, &i);
    bbox.top = (HPDF_REAL)(i * 1000 / attr->header.units_per_em);
...
LoadTTFTable (HPDF_FontDef  fontdef)
{
    ...
    attr->offset_tbl.table = (HPDF_TTFTable*)HPDF_GetMem (fontdef->mmgr,
...
ParseHead (HPDF_FontDef  fontdef)
{
    ...
    fontdef->font_bbox. left = (HPDF_REAL)(attr->header.x_min * 1000 /
                attr->header.units_per_em);
    fontdef->font_bbox. bottom = (HPDF_REAL)(attr->header.y_min * 1000 /
                attr->header.units_per_em);
    fontdef->font_bbox. right = (HPDF_REAL)(attr->header.x_max * 1000 /
                attr->header.units_per_em);
    fontdef->font_bbox. top = (HPDF_REAL)(attr->header.y_max * 1000 /
                attr->header.units_per_em);
                    ...
                    HPDF_UINT32   offset)
{
    ...
    attr->cmap.glyph_id_array = (HPDF_UINT16*)HPDF_GetMem (fontdef->mmgr,
                    ...
                    HPDF_UINT32   offset)
{
    ...
    /* end_count */
    attr->cmap.end_count = (HPDF_UINT16*)HPDF_GetMem (fontdef->mmgr,
    ...
    /* start_count */
    attr->cmap.start_count = (HPDF_UINT16*)HPDF_GetMem (fontdef->mmgr,
            sizeof(HPDF_UINT16) * attr->cmap.seg_count_x2 / 2);
    if (!attr->cmap.start_count)
        return HPDF_Error_GetCode (fontdef->error);
    ...
    /* id_delta */
    attr->cmap.id_delta = (HPDF_INT16*)HPDF_GetMem (fontdef->mmgr,
            sizeof(HPDF_INT16) * attr->cmap.seg_count_x2 / 2);
    if (!attr->cmap.id_delta)
        return HPDF_Error_GetCode (fontdef->error);
    ...
    /* id_range_offset */
    attr->cmap.id_range_offset = (HPDF_UINT16*)HPDF_GetMem (fontdef->mmgr,
            sizeof(HPDF_UINT16) * attr->cmap.seg_count_x2 / 2);
    if (!attr->cmap.id_range_offset)
        return HPDF_Error_GetCode (fontdef->error);
...
ParseHmtx  (HPDF_FontDef  fontdef)
{
     ...
     */
    attr->h_metric = (HPDF_TTF_LongHorMetric*)HPDF_GetMem (fontdef->mmgr,
...
ParseLoca  (HPDF_FontDef  fontdef)
{
    ...
    attr->glyph_tbl.offsets = (HPDF_UINT32*)HPDF_GetMem (fontdef->mmgr,
     ...
     */
    attr->glyph_tbl.flgs = (HPDF_BYTE*)HPDF_GetMem (fontdef->mmgr,
        sizeof (HPDF_BYTE) * attr->num_glyphs);
...
ParseName  (HPDF_FontDef  fontdef)
{
    ...
    attr->name_tbl.name_records = (HPDF_TTF_NameRecord*)HPDF_GetMem (fontdef->mmgr,
                              ...
                              HPDF_Stream    stream)
{
    ...
    new_offsets = (HPDF_UINT32*)HPDF_GetMem (fontdef->mmgr,
            sizeof (HPDF_UINT32) * (attr->num_glyphs + 1));
    if (!new_offsets) {
        HPDF_Stream_Free (tmp_stream);
        return HPDF_Error_GetCode (fontdef->error);
