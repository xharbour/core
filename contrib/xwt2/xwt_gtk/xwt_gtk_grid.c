/*
   ...
   $Id: xwt_gtk_grid.c 9279 2011-02-14 18:06:32Z druzus $
...
static BOOL xwt_gtk_grid_setprop( PXWT_WIDGET widget, char *prop, PHB_ITEM pValue )
{
   ...
   else if ( strcmp( prop, "attach" ) == 0 )
   {
      ...
      gtk_table_attach(
         ...
         (wSelf->bFill? GTK_FILL :0 ) | (wSelf->bShrink? GTK_SHRINK : 0 ) | wSelf->bExpand? GTK_EXPAND : 0,
         (wSelf->bFill? GTK_FILL :0 ) | (wSelf->bShrink? GTK_SHRINK : 0 ) | wSelf->bExpand? GTK_EXPAND : 0,
...
BOOL xwt_gtk_createGrid( PXWT_WIDGET xwtData )
{
   ...
   grid->INH(INH(INH(top_widget))) = xwt_gtk_container_topwidget;
