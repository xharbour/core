...
static hb_KeyData_T * KeyGet( struct hb_BTree * pBTree, ULONG ulNode, int iPosition,
                              hb_KeyData_T * buffer );
static ULONG BranchGet( struct hb_BTree * pBTree, ULONG ulNode, int iPosition );

/* end of forward declarations */

static void raiseError( ULONG ulGenCode, ULONG ulSubCode, const char * szDescription,
...
static void NodeCopy( struct hb_BTree * pBTree, ULONG toNode, int toPosition, ULONG fromNode,
                      int fromPosition,
                      hb_KeyData_T * buffer )
{
   ULONG ulBranch;
...
static HB_BOOL SearchNode( struct hb_BTree * pBTree, hb_KeyData_T * target, ULONG ulNode,
                           int * iPosition )
{
   HB_BOOL        results;
...
static ULONG hb_BTreeSearch( struct hb_BTree * pBTree, hb_KeyData_T * target, int * targetpos,
                                BTreeStack ** pStack )
{
...
static void PushIn( struct hb_BTree * pBTree, hb_KeyData_T * xkey, ULONG xbranch,
                    ULONG ulNode,
                    int iPosition )
{
   hb_KeyData_T * buffer = ( hb_KeyData_T * ) BufferAlloc(
...
static void Split( struct hb_BTree * pBTree, hb_KeyData_T * xkey, ULONG xbranch, ULONG ulNode,
...
#endif
static HB_BOOL PushDown( struct hb_BTree * pBTree, hb_KeyData_T * newkey, ULONG ulNode,
                         hb_KeyData_T ** xkey,
                         ULONG * xbranch )
{
   int               iPosition;
