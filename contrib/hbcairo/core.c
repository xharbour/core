...
{
   cairo_t ** ppCairo = ( cairo_t ** ) hb_parptrGC( hb_cairo_destructor, 1 );
...
{
   cairo_surface_t ** ppSurface = ( cairo_surface_t ** ) hb_parptrGC( hb_cairo_surface_destructor, 1 );
...
{
   cairo_path_t ** ppPath = ( cairo_path_t ** ) hb_parptrGC( hb_cairo_path_destructor, iParam );
...
{
   cairo_path_t ** ppPath = ( cairo_path_t ** ) hb_parptrGC( hb_cairo_path_destructor, 1 );
...
HB_FUNC( CAIRO_PATH_ITERATOR_CREATE )
{
   ...
   if( ppPath && *ppPath )
   {
      PHB_CAIRO_PATH_ITERATOR  pIterator = ( PHB_CAIRO_PATH_ITERATOR ) hb_gcAlloc( sizeof( HB_CAIRO_PATH_ITERATOR ), hb_cairo_path_iterator_destructor );
...
{
   PHB_CAIRO_PATH_ITERATOR  pIterator = ( PHB_CAIRO_PATH_ITERATOR ) hb_parptrGC( hb_cairo_path_iterator_destructor, 1 );
