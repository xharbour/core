/*
 * $Id: zipnew.cpp 9694 2012-09-18 19:35:46Z andijahja $
 */
...
void hb_SetZipComment( const char * szComment )
{
   ...
   hb_xstrcpy( pZipI.szComment, szComment, 0 );
}
...
const char * hb_GetZipComment( const char * szFile )
{
   ...
   hb_xstrcpy( szTempR, ( char * ) szReturn, 0 );
