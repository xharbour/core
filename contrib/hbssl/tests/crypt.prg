/*
 * $Id: crypt.prg 9892 2012-12-24 20:48:13Z andijahja $
 */
...
PROCEDURE Main()
   ...
   FOR EACH tmp IN all
      ? tmp, pub := tmp:exec( "pubkey.pem", "test" )
      IF ! Empty( pub )
   ...
   ? ValType( a ), Len( a )
   ? ValType( a[ 1 ] ), ">" + StrToHex( a[ 1 ] ) + "<"
   ? ValType( iv ), ">" + StrToHex( iv ) + "<"
