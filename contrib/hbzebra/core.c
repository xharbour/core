/*
 * $Id: core.c 9476 2012-06-21 09:26:17Z andijahja $
 */
...
{
   PHB_ZEBRA * ppZebra = ( PHB_ZEBRA * ) hb_itemGetPtrGC( pItem, hb_zebra_destructor );
...
{
   PHB_ZEBRA * ppZebra = ( PHB_ZEBRA * ) hb_gcAlloc( sizeof( PHB_ZEBRA ), hb_zebra_destructor );
...
{
   PHB_ZEBRA * ppZebra = ( PHB_ZEBRA * ) hb_parptrGC( hb_zebra_destructor, iParam );
