/*
 * $Id: test46.prg 9576 2012-07-17 16:41:57Z andijahja $
 */
/*
  test46.prg
  þ sx_FieldCount    ( nArea | cAlias )
  þ sx_FieldDecimals ( cFieldName, nArea | cAlias )
  þ sx_FieldName     ( iFieldNum, nArea | cAlias )
  þ sx_FieldNum      ( cFieldName, nArea | cAlias  )
  þ sx_FieldOffset   ( cFieldName, nArea | cAlias  )
  þ sx_FieldType     ( cFieldName, nArea | cAlias  )
  þ sx_FieldWidth    ( cFieldName, nArea | cAlias  )
*/
#include "sixapi.ch"
