/*
 * $Id: ryo.c 9576 2012-07-17 16:41:57Z andijahja $
 */
...
HB_FUNC( SX_RYOFILTERSETBIT )
{
   ...
   /*
      ...
      iOnOrOff:
      If TRUE, the bit is set and the record becomes visible.
      If FALSE, the bit is reset and is no longer visible when this bitmap is
      activated.
    */
}
