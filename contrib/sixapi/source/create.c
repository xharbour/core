/*
 * $Id: create.c 9576 2012-07-17 16:41:57Z andijahja $
 */
...
HB_FUNC( SX_DBCREATE )
{
   ...
   if( pStruct )
      uiLen = ( USHORT ) HB_ARRAY_LEN( pStruct );
   else
      uiLen = 0;
   ...
   if( ISNUM( 5 ) )        // nCommitLevel Passed
