/*
 * $Id: str.c 9752 2012-10-14 03:33:16Z andijahja $
 */
...
char * _sx_insertchar( char * strbuf, char chrtoins, int pos )
{
...
char * _sx_padl( char * strbuf, char chrtofill, unsigned len )
{
...
char * _sx_padr( char * strbuf, char chrtofill, unsigned len )
{
   while( strlen( strbuf ) < len )
   {
