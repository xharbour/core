...
extern	void _TIFFsetByteArray(TIFF*, void**, void*, uint32);
extern	void _TIFFsetString(TIFF*, char**, char*);
extern	void _TIFFsetNString(TIFF*, char**, char*, uint32);
extern	void _TIFFsetShortArray(TIFF*, uint16**, uint16*, uint32);
extern	void _TIFFsetLongArray(TIFF*, uint32**, uint32*, uint32);
extern	void _TIFFsetFloatArray(TIFF*, float**, float*, uint32);
extern	void _TIFFsetDoubleArray(TIFF*, double**, double*, uint32);
