/*
 * $Id: hbexprb.c 9950 2013-04-19 17:43:56Z zsaulius $
 */
      ...
      case HB_EA_REDUCE:
         {
            ...
            if( pSelf->value.asList.pExprList->ExprType == HB_ET_VARIABLE || pSelf->value.asList.pExprList->ExprType == HB_ET_VARIABLE )
            {
