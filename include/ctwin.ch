/*
 * $Id: ctwin.ch 9482 2012-06-21 13:32:16Z andijahja $
 */
...
#xcommand CTWINON =>;
 ...
 #xtranslate DISPBOX(       =>   ctw_DISPBOX(        ;;
 #xtranslate DISPOUT(       =>   ctw_DISPOUT(        ;;
 #xtranslate DISPOUTAT(     =>   ctw_DISPOUTAT(      ;;
 ...
 #xtranslate SCROLL(        =>   ctw_SCROLL(         ;;
 #xtranslate SETPOS(        =>   ctw_SETPOS(         ;;
...
#xcommand CTWINOFF =>;
 ...
 #xuntranslate DEVPOS(        => ;;
 #xuntranslate DISPBOX(       => ;;
 #xuntranslate DISPOUT(       => ;;
 #xuntranslate DISPOUTAT(     => ;;
 #xuntranslate MAXCOL(        => ;;
 #xuntranslate MAXROW(        => ;;
