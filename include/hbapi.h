/*
 * $Id: hbapi.h 9947 2013-04-09 18:32:17Z zsaulius $
 */
...
extern HB_EXPORT char *    hb_strLTrim( const char * szText, HB_SIZE * ulLen ); /* return a pointer to the first non-white space character */
